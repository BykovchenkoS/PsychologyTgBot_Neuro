...
# Обучение модели
history = model.fit(x_train, y_train, batch_size=1, epochs=70, validation_data=(x_test, y_test), callbacks=[ReduceLROnPlateau(monitor='loss', factor=0.4, verbose=0, patience=2, min_lr=0.0000001)])

model.save("conv_epochs70_my_model_for_audio")
